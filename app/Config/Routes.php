...
$routes->group('transaksi', ['filter' => 'auth'], function ($routes) {
    $routes->get('', 'TransaksiMenuController::index');
    // $routes->post('', 'TransaksiMenuController::create');
    $routes->post('edit/(:any)', 'TransaksiMenuController::edit/$1');
    $routes->get('download', 'TransaksiMenuController::download');
});
